...
public class EnemyGenerationAdminController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateStageProfile(CreateStageProfileDTO dto)
        => Ok(await _service.CreateStageProfileAsync(dto));
    ...
    {
        await _service.UpdateStageProfileAsync(dto);
        return Ok();
    }
    ...
    {
        await _service.DeleteStageProfileAsync(id);
        return Ok();
    }
    ...
    public async Task<IActionResult> CreateStageScenario(Guid stageProfileId, CreateStageScenarioDTO dto)
        => Ok(await _service.CreateStageScenarioAsync(stageProfileId, dto));
    ...
    {
        await _service.UpdateStageScenarioAsync(dto);
        return Ok();
    }
    ...
    {
        await _service.DeleteStageScenarioAsync(id);
        return Ok();
    }
    ...
    public async Task<IActionResult> CreateScenarioSlot(Guid scenarioId, CreateScenarioSlotDTO dto)
        => Ok(await _service.CreateScenarioSlotAsync(scenarioId, dto));
    ...
    {
        await _service.UpdateScenarioSlotAsync(dto);
        return Ok();
    }
    ...
    {
        await _service.UpdateEnemyClassProfileAsync(dto);
        return Ok();
    }
    ...
    {
        await _service.DeleteEnemyClassProfileAsync(id);
        return Ok();
    }
}
